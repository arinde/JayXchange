    ...
    return(
        ...
        <section id="Testimonial" className="bg-gray-100 py-6 mt-10 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <p className="text-center text-gray-700 font-serif text-4xl font-medium">What Our Customers Says</p>
                <div 
                ref={scrollRef}
                className="flex md:flex-row flex-col md:justify-around justify-center gap-4 py-8 px-5 cursor-grab overflow-x-hidden overflow-y-hidden whitespace-nowrap scrollbar-hide">
                    {Testimonials}
                </div>
